export async function generateCanvasCard(params: {
    ...
    const { title, level, xp, progressToNextLevel, rarity, traits, base64Image, floorPrice } = params;
    ...
    // --- 1. Background ---
    roundRectBorder(0, 0, 560, 980, 40, '#0F172A', 'rgba(255,255,255,0.1)', 4);
    ...
    roundRectBorder(imgX, imgY, imgW, imgH, 32, '#1e293b', '#334155', 8);
    ...
    for (let i = 0; i < displayTraits.length; i++) {
        ...
        roundRectBorder(startX, startY, traitW, traitH, 10, 'rgba(255,255,255,0.05)', 'rgba(255,255,255,0.1)', 1);
    ...
    // --- 7. Progress Bar ---
    const progressY = 880;
    roundRectBorder(32, progressY, 496, 6, 3, '#1e293b', 'rgba(255,255,255,0.1)', 1);
